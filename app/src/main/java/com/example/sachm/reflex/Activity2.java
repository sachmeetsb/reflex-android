...
public class Activity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button share = findViewById(R.id.button7);
        share.setEnabled(false);
        perfs = getSharedPreferences("key"+initime, Context.MODE_PRIVATE);
        score1 = perfs.getInt("key"+initime,0);
        Log.i("score is ", ""+score1);
        highs = (TextView) findViewById(R.id.textView4);
    ...
    public void clicky(View v) {
        ...
        if(score>score1)
        {
            ...
            editor.putInt("key"+initime,score);
            editor.apply();
            score1=perfs.getInt("key"+initime,0);
